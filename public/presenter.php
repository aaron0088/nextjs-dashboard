...
$mail = new PHPMailer(true);
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO presenter (name, email, contactno, prefix, organiszation, nationality, file, tshirtsize)
		VALUES ('$name', '$email', '$contactno', '$prefix', '$organiszation', '$nationality', '$file', '$tshirtsize')";
		
		move_uploaded_file($files_tmp, "presenter/".$files_name);
		...
		if (mysqli_query($conn, $sql)) {
		    ?>
             ...
             window.location.href='https://buy.stripe.com/fZebLg8ZxetYbTOcMR'
             </script>  
