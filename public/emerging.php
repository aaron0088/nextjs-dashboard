...
$mail = new PHPMailer(true);
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO emerging (name, email, contactno, prefix, organiszation, nationality, file, tshirtsize, emergencyname, emergencyemail, emergencyno)
		...
		if (mysqli_query($conn, $sql)) {
		    ?>
             ...
             window.location.href='https://buy.stripe.com/fZe8z46Rp3PkcXSaEH'
             </script>  
