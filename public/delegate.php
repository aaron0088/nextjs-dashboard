...
$mail = new PHPMailer(true);
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO delegates (name, email, contactno, prefix, organiszation, nationality, file, tshirtsize, emergencyname, emergencyemail, emergencyno)
		VALUES ('$name', '$email', '$contactno', '$prefix', '$organiszation', '$nationality', '$file', '$tshirtsize', '$emergencyname', '$emergencyemail', '$emergencyno')";
		
		move_uploaded_file($files_tmp, "delegate/".$files_name);
		...
		if (mysqli_query($conn, $sql)) {
		    ?>
             ...
             window.location.href='https://buy.stripe.com/5kAg1wa3B0D83nidQU'
             </script>  
