    ...
    <div className="w-screen h-screen bg-[url('https://test.mnerdsdev.com/Form-bg.svg')] bg-no-repeat bg-cover bg-center ">
      <div className="flex justify-center">
          ...
          <div className="flex items-center justify-center w-screen">
            ...
            <label for="name">Organization Position</label><br/>
            <input className="bg-gray-200 border-2 border-gray-500" id="name" type="text" autocomplete="name" required /> <br/> <br/>

            <label for="name">File Upload</label><br/>
            <input className="" id="name" type="file" autocomplete="name" required /> <br/> <br/>

            <button className="border-2 bg-[#064c7a] text-gray-100 text-2xl p-2 px-[5.1rem] rounded-xl"><a href="/regpref">Register</a></button>
          </form>
          </div>
        </div>
        </div>
