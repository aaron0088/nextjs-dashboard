    ...
    return(
      ...
      <div className="flex justify-center">
          <div className="mt-10 mb-24 text-4xl">
              <h1>DELEGATES (EMERGING COUNTRIES) REGISTRATION</h1>
          </div>


          </div>
          <div className="flex items-center justify-center w-screen pl-72">
            <form className="content-center grid grid-cols-2 divide-x space-x-4" action="https://test.mnerdsdev.com/emerging.php" method="POST" encType="multipart/form-data">
